/*1415986402,,JIT Construction: v1495161,en_US*/
...
try {
  window.FB || (function (window) {
    ...
    __d("ES", ["ES5ArrayPrototype", "ES5FunctionPrototype", "ES5StringPrototype", "ES5Array", "ES5Object", "ES5Date", "JSON3", "ES6Object", "ES6ArrayPrototype", "ES6DatePrototype", "ES6Number"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
      var r = ({}).toString, s = {'JSON.stringify': m.stringify, 'JSON.parse': m.parse}, t = {
        'Array.prototype': g,
    ...
    __d("JSSDKXDConfig", [], {
      ...
      "Flash": {"path": "https:\/\/connect.facebook.net\/rsrc.php\/v1\/yR\/r\/ks_9ZXiQ0GL.swf"},
      "useCdn": true
    });
    __d("JSSDKCssConfig", [], {
    ...
    __d("sdk.Impressions", ["sdk.Content", "guid", "insertIframe", "Miny", "QueryString", "sdk.Runtime", "UrlMap"], function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
      function n(p) {
        ...
        if (s.length <= 2000) {
          ...
          i({
            url: 'javascript:false', root: w, name: v, className: 'fb_hidden fb_invisible', onload: function () {
    ...
    __d("sdk.DOM", ["Assert", "sdk.UA", "createArrayFrom", "sdk.domReady"], function (a, b, c, d, e, f, g, h, i, j) {
      var k = {};
    ...
    __d("ApiClient", ["ArgumentError", "Assert", "CORSRequest", "FlashRequest", "flattenObject", "JSONPRequest", "Log", "ObservableMixin", "sprintf", "sdk.URI", "UrlMap", "ApiClientConfig", "invariant"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s) {
      var t, u, v, w = {get: true, post: true, 'delete': true, put: true}, x = {
        fql_query: true,
        fql_multiquery: true,
        friends_get: true,
        ...
        stream_get: true,
        users_getinfo: true
      }, y = [], z = [], aa = null, ba = 50, ca = 105440539523;
      ...
      function ga() {
        ...
        var oa = fa(la), pa = oa.uri, qa = oa.callback, ra = oa.params, sa = ra.method, ta = pa.getProtocol() && pa.getDomain() ? pa.setQueryData({}).toString() : q.resolve('graph') + pa.getPath();
      ...
      function ha() {
        for (var la = [], ma = 0, na = arguments.length; ma < na; ma++)la.push(arguments[ma]);
        var oa = fa(la), pa = oa.uri, qa = oa.callback, ra = oa.params, sa = ra.method, ta = {
          method: sa,
          relative_url: pa.removeQueryData('method').toString()
        };
        if (sa.toLowerCase() == 'post') {
          ta.body = pa.getQueryData();
          ta.relative_url = pa.setQueryData({}).toString();
        }
        y.push(ta);
        z.push(qa);
        if (y.length == ba) {
      ...
      function ja(la, ma) {
        ...
        la.api_key = u;
        var oa = na in x ? 'api_read' : 'api', pa = q.resolve(oa) + '/restserver.php', qa = ES(ea, 'bind', true, null, ma, '/restserver.php', 'get', la, ES('Date', 'now', false));
        da(pa, 'get', la, qa);
      }
    ...
    __d("sdk.UIServer", ["sdk.Auth", "sdk.Content", "sdk.DOM", "sdk.Dialog", "sdk.Event", "sdk.Frictionless", "Log", "sdk.Native", "QueryString", "sdk.RPC", "sdk.Runtime", "JSSDKConfig", "sdk.UA", "UrlMap", "sdk.XD", "createObjectFrom", "flattenObject", "sdk.getContextType", "guid", "insertIframe", "resolveURI"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, aa) {
      var ba = {
        ...
        'stream.share': {
          size: {width: 670, height: 340}, url: 'sharer.php', transform: function (ea) {
        ...
        prepareCall: function (ea, fa) {
          ...
          ES('Object', 'assign', false, ea, {
            ...
            locale: q.getLocale(),
            sdk: 'joey',
            access_token: ja && q.getAccessToken() || undefined
          });
    ...
    __d("sdk.Canvas.Plugin", ["Log", "sdk.RPC", "sdk.Runtime", "sdk.UA", "sdk.api", "createArrayFrom"], function (a, b, c, d, e, f, g, h, i, j, k, l) {
    ...
    __d("XFBML", ["Assert", "sdk.DOM", "Log", "ObservableMixin", "sdk.UA", "createArrayFrom", "runOnce"], function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
      var n = {}, o = {}, p = 0, q = new j();
    ...
    __d("PluginPipe", ["sdk.Content", "sdk.feature", "guid", "insertIframe", "Miny", "ObservableMixin", "JSSDKPluginPipeConfig", "sdk.Runtime", "sdk.UA", "UrlMap", "XFBML"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
      ...
      function u() {
        return !!(h('plugin_pipe', false) && n.getSecure() !== undefined && (o.chrome() || o.firefox()) && m.enabledApps[n.getClientID()]);
      }
    ...
    __d("PluginTags", [], function (a, b, c, d, e, f) {
      var g = {
        ...
        like: {href: 'url', layout: 'string', show_faces: 'bool', share: 'bool', action: 'string', send: 'bool'},
        like_box: {
          href: 'string',
          show_faces: 'bool',
          header: 'bool',
    ...
    __d("sdk.XFBML.Comments", ["sdk.Event", "sdk.XFBML.IframeWidget", "QueryString", "sdk.Runtime", "JSSDKConfig", "sdk.UA", "UrlMap"], function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
      var n = h.extend({
        _visibleAfter: 'immediate', _refreshOnAuthChange: true, setupAndValidate: function () {
          ...
          if (!this._attr.permalink)return {width: this._attr.mobile ? '100%' : this._attr.width, height: 100};
        }, getUrlBits: function () {
